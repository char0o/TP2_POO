...
namespace TP2.Tests
{
    ...
    public class UtilityTests
    {
        ...
        public void PrintFormattedColoredTextDifferentSizesOfArraysTest()
        {
            ...
            Utility.PrintFormattedColoredText("", strings, colors);
        }
        [TestMethod()]
        [ExpectedException(typeof(ArgumentException))]
        public void PrintFormattedColoredTextDifferentFormatTest()
        {
            ...
            string[] strings = new string[] { "Hello", "World" };
            ConsoleColor[] colors = new ConsoleColor[] { ConsoleColor.Red };
            Utility.PrintFormattedColoredText(format, strings, colors);
        }
        [TestMethod()]
        ...
        public void CreateMenuFromEnumTest()
        {
            ...
            string menu = Utility.CreateMenuFromEnum<TestEnum>(new string[] { "OPTION1", "OPTION2", "OPTION3" });
        ...
        public void CreateMenuFromEnumStartingFrom1Test()
        {
            ...
            string menu = Utility.CreateMenuFromEnum<TestEnum2>(new string[] { "OPTION1", "OPTION2", "OPTION3" });
            Assert.AreEqual(EXPECTED, menu);
        }
        [TestMethod()]
        [ExpectedException(typeof(ArgumentException))]
        public void CreateMenuFromEnumSimilarArgsTest()
        {
            ...
            string menu = Utility.CreateMenuFromEnum<TestEnum2>(new string[] { "OPTION1", "OPTION2" });
        }
    }
}